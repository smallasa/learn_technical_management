...
## 16.团队建设该从哪里入手？
在需求调研的时候，我问技术团队负责人："你期待通过这个工作坊，解决什么样的问题，并收获什么样的效果？" 
他认真的跟我说："我希望能够让管理者了解到，如何群策群力打胜仗！" 紧接着，又补充道："CEO也是这么期待的。"

听他这么说，我第一反应就是，高管就是高管，说话高屋建瓴，直达要害。我们做管理工作的目标，归根结底，不就是"群策群力打胜仗"吗？
"群策群力"就是如何带好团队，"打胜仗"就是如何取得好的业绩，"带人" + "做事" ，齐了。可问题是，具体从哪里着手呢？

做具体的管理工作，和做一场培训是相通的，都需要又针对性的目标。"群策群力打胜仗"是终极目标，但还是不知道要解决什么问题，于是我接着问他：
"你希望通过解决或改善什么问题，来更好的实现'群策群力打胜仗'这个目标呢？毕竟这是每位管理者的理想，那么具体到你的团队，你希望着手做哪几件事呢？"

他若有所思，然后跟我说："团队的经理大部分都是工程师转的管理，即便有人也已经带过几十人的团队了，却还是不太清楚管理都该做哪些事情，
有时候还没有把自己放在管理角色来看待工作中的问题；另外，我们这些管理者彼此间也需要更好的融洽，大家合作的时间并不长，凝聚力还不够..."

我试着总结："听下来，你是希望通过做这样两件事，来更好的群策群力打胜仗：第一，提升管理者角色认知，让他们清楚自己作为leader都要做哪些工作；
第二，是团队融合，你希望工作坊之后，经理间有更好的互信和默契。"

他连连点头说："对对对，就是这个意思..."

于是，我再一次看到，对于管理者来说，"管理"是多么复合一个词汇，它包含太多层次和维度，每位管理者都会有自己不同的理解和表述。
做管理工作，如果仅凭感觉泛泛地去做，效果是很难预期的。因此，对于管理工作来说，有哪些具体的切入点，可以让管理者围绕这些"切入点"去开展工作，是非常值得探讨的。

关于管理者都需要做哪些工作的问题，前面章节已经给出来一个管理框架，我把它称为"管理三明治"。这个"三明治"有三根"火腿肠"，对应管理者的三项日常工作：
"管理规划"、"团队建设"、"任务管理"，通俗的话来说，就是"看方向"、"带人"、"做事"。

![管理三明治](static/images/16/管理三明治.png)

今天，我们来讲讲第二根"火腿肠"，聚焦如何"带人"。"带人"，其实就是我们常说的"带团队"、"团队建设"。
显然，所有的团队都需要有目标和方向感，也都需要在任务执行的过程中去锤炼和打磨，和"看方向"、"做事"这两根"火腿肠"脱不开关系。

那么，究竟这么带好团队呢？带团队需要从哪几个维度去展开工作呢？我采访过的一些新经理、或一些二线经理，大家的说法各不相同，让我深感意外，似乎又在情理之中：
* 带团队的核心是要做好人
* 最重要的是把合适的人放在合适的位置上
* 对团队来说，最重要的是梯队和氛围
* 一个好的团队是各有所长，协同配合
...
虽然说法不一，但每个人都说的有道理，蕴含着真知灼见和各自管理精髓，每一个真知拙见都能在我脑海中点亮一颗明星。突然之间，我一时有些眼花缭乱、不知所措。
我到底该去摘哪一颗呢？有没有一个"星谱图"，能够把这些散落的繁星连接成一幅有意义的图画呢？那我就可以按图去寻找我需要的星星了。

作为一个有追求的工程师出身的管理者，散落一地的经验是不能令我满意的，我一定要找到"带团队"这个主题的系统性框架，然后把这些宝贵的经验都安放进去。

既然要研究如何"带团队"，我们就先好好分析分析，"团队"这个研究对象。
为了容易理解，再次以"马车模型"来说明，当我们研究的是团队，也就是"马车模型"中拉车的"马队"，我们就来分析分析这个"马队"。
![奔跑的马车](static/images/16/奔跑的马车.png)

观察一个马队，至少可以从三个层次来看：
* 第一个层次，就是单个的马，马队是由一匹一匹个体的马组成的。
* 第二个层次，个体马和个体马之间是有连接的，如果没有连接在一起，它们就不能作为拉同一辆车的马。
* 第三个层次，马队是有其整体性的，马队的规模，马队的气势，马队整体的耐力等等。

这样，我们就把"马队"这一研究对象拆解成了三个子对象："马匹个体"、"马匹之间"、"马队整体"。

首先，我们从"马匹个体"来看。  
一个好的马队，每匹马都应该是奋力向前的。如何向前呢？这里包含两个要素：  
1.力气。首先一匹马本身得有力气，这是马车前进的基础。如何让一匹马有力气就是一个好的工作切入点。如何提升马匹的力气或体能，这对应到团队工作中，就像如何培养员工的工作能力一样。  
2.意愿。只有力气是不够的，要让马匹奋力向前，除了"力气"，还得有意思，就是得给马匹一个理由，让它愿意使劲地拉车。这对应到我们团队工作中，就是员工激励；去提升员工的工作意愿。  

还有没有其他要素呢？可能有，但对于个体角度的工作来说，"能力 + 意愿"，已经足够。

然后，我们从"马匹之间"来看。  
显然，每匹马都奋力向前，车就一定快吗？除了马匹个体用力，还有什么要素会影响到车的速度呢？这里也有两个要素：  
1.马队的阵型，即排兵布阵。说白了就睡，马和马之间是用什么结构连接起来的，这决定了各匹马用力的方向是什么。即便两匹马都很拼命，但是如果它们往两个相反的方向用力，
马车也是不动的。具体到我们团队，就对应到人员分工上。正常情况下，我们都不会做出相反的分工，但是如果对于同一件事情，一个员工在努力的赶进度，
而另一个员工在拼命的追求质量，那么显然他们是在往不同的方向努力。所以分工不是简单的"谁做啥"的问题，还包括是否有相互统一的评估维度。
2.节奏和默契。如果阵型结构能保证所有马匹往一个方向努力，车就快了吗？未必，还有一个要素需要考虑，就是马与马之间，有没有一致的节奏和良好的默契，这也是很重要的。
具体到我们团队就是，团队成员间有没有很好的信任和默契，协作上是否高效顺畅，是不是只需要只言片语、一个眼神、一个手势就能心领神会。这也决定了我们团队这架马车能跑多快。

还有没有其他要素呢？如果把 "分工" 和 "协作" 搞好了，就已经抓住了最核心的要素。

最后，我们从"马车整体"来看。  
如果说我们研究"马匹个体"，是为了搞清楚如何让"马跑得快"；我们研究"马匹之间"的构造，是搞清楚如何让"车跑的快"；那么，我们研究"马队整体"，主要是想看看，
如何才能让马车"一直跑的快"，或者说，跑得远，也就是团队的耐力和可持续性问题。

我们可以从外部来给团队很多激励，比如愿景目标和使命，比如带团队做出好的业绩和大的成就，这些方面呢，我们会在管理规划和任务管理这两根"火腿肠"中探讨。
今天，我们仅从团队角度来看，如何提升团队的耐力。也是包含两个要素：
1. 马队构成 Vs 团队梯队。从这个角度来审视马队，对应到团队就是梯度，盘点团队新老强弱的构成。团队工作是着眼长线的工作，我们不是只赶一段路。
一个团队如果没有良好的梯队，只是靠一两个成熟高手在支撑，那么一旦这一两个高手请假、调走或离职，整个团队就瘫痪了。
所以，要把团队的战斗力放在一个更长的时间区间去考虑。
2. 马队展现出来的气势和精神面貌 Vs 团队文化。 团队文化如果你觉得难以捉摸，要额可以叫"团队气氛"，总之就是团队成员能够在这里找到非常好的认同感，
大家也非常清楚在这个团队里，什么是重要的，什么是不重要的，什么是应该的，什么是不应该的，都不需要一点一点交代。
我们可能平时也不会特别注意到，但是却无处不在。一个公司因为文化发生变化而带来的团队动荡，是灾难性的、难以缓解的，所以不能忽视团队文化的建设。

综上，我们对"马队" 三个层次的解析，就得到团队建设的六个维度工作要素：
* 针对员工个体的两个要素：能力 和 激励
* 针对员工个体之间的两个要素：分工 和 协作
* 针对团队整体的两个要素：梯队 和 文化
![团队建设六要素](static/images/16/团队建设六要素.png)
